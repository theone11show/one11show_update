        ...
        <ul className="hidden md:flex space-x-6 text-lg items-center">
          ...
          <li className="relative group dropdown-container">
            ...
            <ul className="absolute hidden group-hover:block bg-charcoal-black text-cream-white p-4 rounded-md shadow-lg dropdown-menu">
              <li>
                <Link to="home" className="block py-1 nav-link">
                  About Us
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="privacy" className="block py-1 nav-link">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="terms" className="block py-1 nav-link">
                  Terms of Service
                </Link>
              </li>
            </ul>
          ...
          <li className="relative group dropdown-container">
            ...
            <ul className="absolute hidden group-hover:block bg-charcoal-black text-cream-white p-4 rounded-md shadow-lg dropdown-menu">
              <li>
                {" "}
                <Link to="bands-section" className="block py-1  nav-link">
                  Battle of Bands
                </Link>
              </li>
              <li>
                <Link
                  to="singer-songwriter-section"
              ...
              <li>
                <Link to="musicians-section" className="block py-1 nav-link">
                  Musicians (Instrumental)
                </Link>
              </li>
              <li>
                <Link to="rappers-section" className="block py-1 nav-link">
                  Battle of Rappers
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="djs-section" className="block py-1 nav-link">
                  Battle of DJs
                </Link>
              </li>
              <li>
                <Link to="challenge-section" className="block py-1 nav-link">
                  48-Hours Music Making Challenge
                </Link>
              </li>
            </ul>
          </li>
