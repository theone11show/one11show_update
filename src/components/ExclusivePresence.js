...
const ExclusivePresence = () => {
  return (
    <div
      className="p-6 sm:p-8 bg-cover bg-center relative"
    ...
    >
      ...
      <div className="relative z-10">
        {/* Block 1 */}
        <div className="mb-12 font-extrabold">
          <h2 className="font-['Montserrat'] text-[#e4e2dd] text-[40px] mb-4">
            EXCLUSIVE PRESENCE
          </h2>
          ...
          <p className="font-['Montserrat'] text-white text-[19px] leading-relaxed mt-4">
        ...
        <div className="mb-20 font-extrabold">
          <h2 className="font-['Montserrat'] text-[#e4e2dd] text-[40px] mt-16">
            Music battle series
          </h2>
          <p className="font-['Montserrat'] text-white text-[19px] leading-relaxed">
        ...
        <div className="mt-16 mb-20 font-extrabold">
          <h2 className="font-['Montserrat'] text-[#e4e2dd] text-[40px]">
            Dj night with TASIA
          </h2>
          <p className="font-['Montserrat'] text-white text-[19px] leading-relaxed">
        ...
        <div className="mt-16 mb-20">
          <h2 className="font-['Montserrat'] text-[#e4e2dd] text-[40px] font-extrabold mt-16">
...
export default ExclusivePresence;
